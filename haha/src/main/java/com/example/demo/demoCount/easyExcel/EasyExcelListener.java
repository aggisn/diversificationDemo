 ...
 */
@Slf4j
public class EasyExcelListener<T, S> implements ReadListener<T> {
     ...
     * @param
     */
    public  EasyExcelListener(S mapper) {
        this.mapper = mapper;
    }
    ...
    private void saveData() {
        ...
        int i = ((Basemapper) mapper).batchInsert((List<org.apache.poi.ss.formula.functions.T>) list);
